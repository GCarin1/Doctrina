...
- An `AGENTS.md` template that follows the open standard, with a CLI-owned
  command-surface block generated from the installed CLI and regenerated by
  `doctrina upgrade --write` (ADR 0015) — agents discover commands through
...
- Adapters for 12 AGENTS.md-aware agents (Claude Code, OpenAI Codex CLI,
  ...
  Factory, Jules).
- Ten capability specs and the ADRs 0001–0025 that describe the framework

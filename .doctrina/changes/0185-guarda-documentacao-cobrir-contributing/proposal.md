# Change 0185-guarda-documentacao-cobrir-contributing — o guarda de documentação deve cobrir CONTRIBUTING, examples, .github, skills e product.md

- **Status:** proposed
- **Date:** 2026-09-24
- **Owner:**
- **Lane:** product (confident; signals: deve)
- **Affects specs:**
...
o guarda de documentação deve cobrir CONTRIBUTING, examples, .github, skills e product.md

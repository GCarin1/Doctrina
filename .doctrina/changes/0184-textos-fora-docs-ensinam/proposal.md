# Change 0184-textos-fora-docs-ensinam — textos fora de docs ensinam comandos depreciados: CONTRIBUTING, exemplo python, template de issue, skills e product.md, e um AGENTS.md de teste esquecido no pacote
...
textos fora de docs ensinam comandos depreciados: CONTRIBUTING, exemplo python, template de issue, skills e product.md, e um AGENTS.md de teste esquecido no pacote

...
**Maintain** (per-command triggers: `doctrina <command> --help`) — `templates list|check|update` · `hooks install` · `index rebuild` · `watch` · `metrics` · `report` · `completion` · `upgrade --write`
